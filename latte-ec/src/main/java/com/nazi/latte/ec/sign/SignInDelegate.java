package com.nazi.latte.ec.sign;
...
import com.nazi.latte.wechat.callbacks.IWeChatSignInCallback;
...
public class SignInDelegate extends LatteDelegate {
    ...
    void onClickSignIn() {
        if (checkForm()) {
            RestClient.builder()
                    .url("http://192.168.222.106:8080/RestDataServer/api/user_profile.php")
