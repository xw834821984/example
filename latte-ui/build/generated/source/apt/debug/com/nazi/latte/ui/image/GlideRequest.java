package com.nazi.latte.ui.image;
...
public final class GlideRequest<TranscodeType> extends RequestBuilder<TranscodeType> {
  ...
  /**
   * @see GlideOptions#centerCrop(Context)
   */
  public GlideRequest<TranscodeType> centerCrop(Context context) {
    if (getMutableOptions() instanceof GlideOptions) {
      this.requestOptions = ((GlideOptions) getMutableOptions()).centerCrop(context);
    } else {
  ...
  /**
   * @see GlideOptions#optionalCenterInside(Context)
   */
  public GlideRequest<TranscodeType> optionalCenterInside(Context context) {
    if (getMutableOptions() instanceof GlideOptions) {
      this.requestOptions = ((GlideOptions) getMutableOptions()).optionalCenterInside(context);
    } else {
  ...
  /**
   * @see GlideOptions#circleCrop(Context)
   */
  public GlideRequest<TranscodeType> circleCrop(Context context) {
    if (getMutableOptions() instanceof GlideOptions) {
      this.requestOptions = ((GlideOptions) getMutableOptions()).circleCrop(context);
    } else {
  ...
  /**
   * @see GlideOptions#optionalTransform(Context, Transformation<Bitmap>)
   */
  public GlideRequest<TranscodeType> optionalTransform(Context context,
      Transformation<Bitmap> transformation) {
    if (getMutableOptions() instanceof GlideOptions) {
      this.requestOptions = ((GlideOptions) getMutableOptions()).optionalTransform(context, transformation);
    } else {
